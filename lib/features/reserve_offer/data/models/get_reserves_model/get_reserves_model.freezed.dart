...
class _$GetReservesModelTearOff {
  ...
  _GetReservesModel call(int success, List<Reserve> reserves) {
...
mixin _$GetReservesModel {
  ...
  List<Reserve> get reserves => throw _privateConstructorUsedError;
...
abstract class $GetReservesModelCopyWith<$Res> {
  ...
  $Res call({int success, List<Reserve> reserves});
}
...
class _$_GetReservesModel implements _GetReservesModel {
  const _$_GetReservesModel(this.success, this.reserves);
  ...
  @override
  String toString() {
    return 'GetReservesModel(success: $success, reserves: $reserves)';
  }
...
abstract class _GetReservesModel implements GetReservesModel {
  const factory _GetReservesModel(int success, List<Reserve> reserves) =
      _$_GetReservesModel;
